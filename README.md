...
> **Full-Stack Developer** building production software end-to-end — from data model to UI to deployment.
> Work shipped to production for **GAT Assurances** and **Transcom**.

---

## About

<img align="right" width="300" alt="coding" src="https://media.giphy.com/media/qgQUggAC3Pfv687qPC/giphy.gif" />

I'm a software-engineering student at **ESPRIT** (Tunis) who likes turning real, messy problems into clean, production-grade products.

- 💼 **Full-Stack Developer @ IAJTechnology** — building the Tagstream / RFIDIA product line
- 🏢 **Shipped to production for GAT Assurances & Transcom**
- 🧩 Focused on **multi-tenant SaaS**, **microservices** (Kafka, Spring Cloud) and **AI features**
- 🛡️ Comfortable across the stack: databases, REST/API design, UI, Docker/K8s, CI/CD
- 🎯 **Open to a final-year internship (PFE)** — Europe · Remote · Tunisia
- 🔗 **[Portfolio →](https://portfolio-lake-ten-aenjyi3gsp.vercel.app/)** &nbsp;·&nbsp; 📫 oussema.kachti@esprit.tn
...
| Project | What it is | |
|---|---|---|
| **Tagstream ERP** | Multi-tenant ERP (CRM · Finance · HR) — SSO, tenant isolation, platform switcher & self-service pack store | [Case study →](https://portfolio-lake-ten-aenjyi3gsp.vercel.app/work/tagstream-business-suite) |
| **SmartProperty** | AI real-estate SaaS — GPT-4 listings, ML price estimation (AVM), 3D virtual tours | [Case study →](https://portfolio-lake-ten-aenjyi3gsp.vercel.app/work/smartproperty) |
| **RFID Attendance** | School-attendance platform — web + mobile + real-time middleware across 4 reader vendors | [Case study →](https://portfolio-lake-ten-aenjyi3gsp.vercel.app/work/rfid-attendance) |
| **Massroufi** | Personal-finance SaaS for students (React 19 · Supabase · RLS) | [Case study →](https://portfolio-lake-ten-aenjyi3gsp.vercel.app/work/massroufi) · [Repo →](https://github.com/OussemaKachti/dashboard_money_management) |
...
![Kafka](https://img.shields.io/badge/Apache_Kafka-000?style=flat-square&logo=apachekafka&logoColor=white)
...
<picture>
  ...
  <img alt="snake" src="https://raw.githubusercontent.com/OussemaKachti/OussemaKachti/output/github-snake.svg" />
</picture>
